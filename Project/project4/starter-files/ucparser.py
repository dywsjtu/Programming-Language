...
precedence = (
    ...
    ('right', 'PREFIX', 'LNOT', 'INCREMENT', 'DECREMENT'),
...
def error_count():
    """Returns the number of errors encountered during lexing and
    parsing."""
    return num_errors

def parse(filename):
    """Reads the given uC source file, parses it, and returns an
    AST."""
